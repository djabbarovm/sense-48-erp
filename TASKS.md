...
- [ ] P-16 Services marketplace (blueprint §12: заказы услуг → партнёр/собственная эксплуатация → QA → GMV) и документы по договорам аренды (загрузка/просмотр в Owner Portal)
