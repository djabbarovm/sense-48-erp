...
- [ ] P-15 Wave 4: заявки и инциденты (WorkOrder: категория, приоритет, SLA, исполнитель, фото-подтверждение, QA) — источник operationalStatus; Owner Portal (роль PROPERTY_OWNER ↔ PropertyOwner: свои юниты, договоры, выплаты, заявки, согласия)
