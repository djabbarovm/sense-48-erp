export type MigrationType = 'vendors' | 'contracts' | 'open_ap' | 'open_ar' | 'employees' | 'budgets' | 'inventory' | 'floorplan' | 'onec_counterparties' | 'onec_osv' | 'onec_staff' | 'didox_registry';
